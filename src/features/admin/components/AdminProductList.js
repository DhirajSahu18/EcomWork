...
import {
  ...
  selecttotalItems,
  fetchAllBrandssAsync,
  fetchAllCategoriesAsync,
  selectAllBrands,
  selectAllCategories,
  UpdateProductAsync,
  fetchAllSelectedProductAsync
...
export default function AdminProductList() {
  ...
  const handleDelete = ( product)=>{
    console.log(product)
    const newProduct = {...product , status : "deleted"}
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
              ...
              <div className="lg:col-span-3">
                ...
                <div className="bg-white">
                    ...
                    <button className="text-sm font-semibold leading-6 text-gray-900 bg-green-700 w-36 h-12 mx-10 rounded-lg">Add New Product</button></Link>
